# scannerprt
Un scanner multithreadé en C++ qui scanne les 65535 ports en moins de 30 secondes, je travaille sur une version plus intelligente du scanner pour le moment, je mettrai une autre version future sur ce repos.

Ce scanner de ports en C++ pour Windows (WinSock2) est conçu pour la vitesse. Il peut analyser 65 535 ports en moins de 30 secondes grâce à une architecture multithreadée optimisée.
