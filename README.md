...
Ce scanner de ports en C++ pour Windows (WinSock2) est conçu pour la vitesse. Il peut analyser 65 535 ports en moins de 20 secondes grâce à une architecture multithreadée optimisée.
